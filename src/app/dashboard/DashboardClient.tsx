      ...
      <main className="flex-1 relative bg-stone-100 h-[50vh] md:h-auto">
        {isAuthenticated && (
          <button
            ...
            className="absolute top-4 left-4 z-[1000] rounded-full bg-white/95 px-4 py-2 text-sm font-medium text-stone-700 shadow-lg ring-1 ring-stone-200 transition hover:bg-white"
          >
